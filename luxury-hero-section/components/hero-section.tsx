...
// Cinematic "sculpted from the void" blur reveal
...
export default function HeroSection() {
  // Parallax tracking for the right-hand showcase
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden flex items-center bg-gradient-to-br from-rose-50 via-white to-pink-100 text-slate-900">
      ...
      {/* Vertical editorial side label — desktop only */}
      ...
      <div className="absolute top-0 left-0 right-0 z-20">
        <div className="container mx-auto px-6 py-8 flex items-center justify-between">
          ...
          >
            gvantsas<span className="text-[#D4AF37]">page</span>
          </motion.span>
          <motion.nav
            initial={{ opacity: 0, y: -12 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {["Jewelry", "Perfume", "Skincare"].map((item) => (
              <a
                key={item}
                href="#"
                className="group relative py-1 transition-colors duration-300 hover:text-[#B8941F]"
              >
                {item}
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 relative z-10 pt-28 pb-28 lg:pt-44 lg:pb-24">
        ...
        >
          ...
          <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-light leading-[0.95] sm:leading-[0.92] tracking-tight text-slate-900">
            ...
            <motion.span variants={itemVariants} className="block text-[#D4AF37] italic">
              FLAME.
            </motion.span>
            <motion.span variants={itemVariants} className="block">
              GLOW.
          ...
          >
            Discover the essence of luxury. Exclusive jewelry, signature perfumes, and
            premium skincare — tailored for those who wear elegance like a second skin.
          </motion.p>
          ...
          >
            <Stat value="120+" label="Curated Pieces" />
            <span className="h-8 w-px bg-slate-900/10" />
            <Stat value="40" label="Maison Partners" />
            <span className="h-8 w-px bg-slate-900/10" />
            <Stat value="1924" label="Est. Heritage" />
          </motion.div>
        </motion.div>

        {/* RIGHT — Asymmetrical staggered floating showcase */}
        <div
          ref={showcaseRef}
        ...
        >
          ...
          <ParallaxImage
            ...
            alt="Luxury faceted perfume bottle with golden cap"
          ...
          <ParallaxImage
            ...
            delay={0.6}
          />
          {/* Skincare (floating bottom-left) */}
          <ParallaxImage
            src="/images/blush-skincare.png"
            alt="Luxury skincare serum bottle with gold dropper"
      ...
      >
        <span className="font-sans text-[10px] uppercase tracking-[0.4em] text-slate-400">
          Scroll
        </span>
        <motion.span
    ...
    >
      ...
      >
        ...
        <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full border border-[#D4AF37]/30 bg-white/80 px-3 py-1 backdrop-blur-md shadow-sm opacity-0 translate-y-1 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0">
          <span className="font-sans text-[8px] uppercase tracking-[0.25em] text-slate-700">
            {caption}
          </span>
        </div>
      </motion.div>
      ...
      >
        {[...words, ...words, ...words, ...words].map((word, i) => (
          <span key={i} className="flex items-center gap-10 shrink-0">
            <span className="font-sans text-[10px] uppercase tracking-[0.35em] text-slate-500">
              {word}
            </span>
